...
(
	...
	expect_success "accept preview root path" validate_preview_root "/var/lib/htmlservd/websites/sample/envs/staging/current"
	...
	expect_success "accept preview website component" validate_preview_path_component "HTMLSERVD_PREVIEW_WEBSITE" "sample"
...
(
	...
	expect_success "accept preview website component in ssh entrypoint" validate_preview_path_component "HTMLSERVD_PREVIEW_WEBSITE" "sample"
